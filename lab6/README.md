...
before submit: 
   Have it working on actual live server 
   Zap Report 
   change back checking for RPI email
   Have all of opportunities for improvement as issues 
...
Lenses of User Experience: 
   ...
   Useful: 
      ...
      What I observe: 
         In its current state, I wouldn't deem our application as useful because it does not yet complete the task it is intended to do. Although, there are defintley 
      ...
      Implementation: 
         make found item submission go to the database for recorders 
   ...
   Desireable: 
      ...
      Implementation: 
         Give user feedback that a confirmation email has been sent 
   ...
   Accessible:
      ...
      What I observe: 
         The main thing I looked for was alt tags and we have all of that there. Buttons are large and simple build is easy to navigate. COuld have some improvements
      ...
      Implementation: 
         Prevent against <3 character inputs for reporting lost item 
   ...
   Findable: 
      ...
      Opportunities for Imporovement:
         Could change the color of found and lost tabs in recorder view
