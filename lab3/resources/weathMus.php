   ...
   <div id="mainSec">
      ...
      <div class="mainHold">
         ...
         <div class="innerHold" id="weather">
            ...
            <div class="mainHold">
               <div class="innerHold" id="weatherPng">
                  <img id="curWeath" alt="Current Weather png" src="back.jpg" >
               </div>
         ...
         <div class="innerHold" id="Music">
            ...
            <img id="spotIm" alt="Spotify Logo" src="spotify.png">
            <ul id="spotUl">
               <li>
                  <div class="listFlex">
                     <div class="playInfo">
                     ...
                     <img class="playIm" id="oneIm" alt="playlist #1 Image" src="spotify.png">
                  </div>
               </li>
               <li>
                  <div class="listFlex">
                     ...
                     <img class="playIm" id="twoIm" alt="playlist #2 Image" src="spotify.png">
                  </div>
               </li>
               <li>
                  <div class="listFlex">
                     ...
                     <img class="playIm" id="threeIm" alt="playlist #3 Image" src="spotify.png">
                  </div>
               </li>
               <li>
                  <div class="listFlex">
                     ...
                     <img class="playIm" id="fourIm" alt="playlist #4 Image" src="spotify.png">
                  </div>
               </li>
               <li>
                  <div class="listFlex" id="lastLi">
                     ...
                     <img class="playIm" id="fiveIm" alt="playlist #5 Image" src="spotify.png">
                  </div>
               </li>
